...
1. This feature is probably just for my own enjoyment, and that fine. :)
...
The plugin is now available in the [Obsidian Community Hub](https://community.obsidian.md/plugins/markdown2html).
